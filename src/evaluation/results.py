...
class TestSuiteResult:
    ...
    def compute_total_accuracy(self) -> float:
        ...
        total_true_negative_count = self.compute_total_true_negative_count()
        
        denominator = total_true_positive_count + total_false_positive_count + total_false_negative_count + total_true_negative_count
        if denominator == 0:
            return 0.0
        
        return (total_true_positive_count + total_true_negative_count) / denominator
