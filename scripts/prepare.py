...
try:
    ...
    shutil.copytree("java-example/src/main/java",       tmp_dir / "source")
    shutil.copytree("java-example/src/test/java",       tmp_dir / "test-source")
    shutil.copytree("java-example/target/classes",      tmp_dir / "classes")
    shutil.copytree("java-example/target/test-classes", tmp_dir / "test-classes")
